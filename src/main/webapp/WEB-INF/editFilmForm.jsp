		...
		<div class="w-75 mx-auto border p-4 form-border">
			...
			<form action="" method="POST">
				...
				<label for="description">Film Description: <br> <textarea
						...
						placeholder="Enter Film Description"></textarea></label><br> <label
					for="release_year">Release Year: <input name="release_year"
				...
				</select></label><br> <label for="rental_duration">Rental Duration: <input
					name="rental_duration" type="number" min="3" max="7"
					placeholder="Select rental duration" value="3"></label><br> <label
					for="rental_rate">Rental Rate: <input name="rental_rate"
					placeholder="Enter rental rate" value=".99" type="number"
					min="0.00" max="5" step="0.50"></label><br> <label
					for="length">Film Length: <input name="length"
					type="number" placeholder="Enter film length" value="120"></label><br>
				<label for="replacement_cost">Replacement cost: <input
					name="replacement_cost" placeholder="Enter replacement cost"
					type="number" value="0.00" step="0.50" min="0" max="20"></label><br>
